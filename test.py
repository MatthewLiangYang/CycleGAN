...
netG_A2B.load_state_dict(torch.load("models/netG_A2B.pth", map_location=device))
netG_B2A.load_state_dict(torch.load("models/netG_B2A.pth", map_location=device))
...
data_root = "/Users/liangyang/Desktop/CycleGAN/datasets/apple2orange"
